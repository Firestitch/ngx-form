...
var FsFormDirective = (function () {
    function FsFormDirective(fsForm) {
        this.fsForm = fsForm;
    ...
    FsFormDirective.prototype.ngOnInit = function () {
        var _this = this;
        if (this.ngForm) {
            this.ngForm.ngSubmit.subscribe(function (event) {
                if (event) {
                ...
                _this.fsForm.broadcast('submit', _this.ngForm);
                var validations = [];
                for (var key in _this.ngForm.controls) {
                    if (!_this.ngForm.controls[key]) {
                        continue;
                    }
                    var control = _this.ngForm.controls[key];
                    control.markAsDirty();
                ...
                Promise.all(validations)
                    ...
                    if (_this.ngForm.form.status === 'INVALID') {
                        _this.fsForm.broadcast('invalid', _this.ngForm);
                        if (_this.invalid) {
                            _this.invalid.emit(_this.ngForm);
                        }
                    }
                    else {
                        _this.fsForm.broadcast('valid', _this.ngForm);
                        if (_this.submit) {
                            _this.submit.emit(_this.ngForm);
                        }
                    }
                });
            });
    ...
    __decorate([
        core_1.ContentChild(forms_1.NgForm),
        __metadata("design:type", Object)
    ], FsFormDirective.prototype, "ngForm", void 0);
    __decorate([
        core_1.Output('fsForm'),
    ...
    FsFormDirective = __decorate([
        ...
        __metadata("design:paramtypes", [fsform_service_1.FsForm])
    ], FsFormDirective);
...
/***/ "../src/services/fsform.service.ts":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../src/services/fsformcommon.service.ts":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__("../node_modules/@angular/core/esm2015/core.js");
var phone_1 = __webpack_require__("../node_modules/@firestitch/common/validate/phone/index.js");
var email_1 = __webpack_require__("../node_modules/@firestitch/common/validate/email/index.js");
var lodash_1 = __webpack_require__("../node_modules/lodash/lodash.js");
var FsFormCommon = (function () {
    function FsFormCommon() {
    }
    FsFormCommon.prototype.renderErrors = function (instance, controlRef, renderer, elRef) {
        if (controlRef.dirty) {
            ...
            var isGroup = ['FS-CHECKBOX-GROUP', 'FS-RADIO-GROUP'].indexOf(elRef.nativeElement.tagName) !== -1;
            if (isGroup) {
                elRef.nativeElement.name = elRef.nativeElement.getAttribute('name');
                var wrapper = elRef.nativeElement.querySelector('.mat-input-subscript-wrapper');
...
module.exports = "<fs-examples title=\"Form Examples\">\n  <fs-example title=\"All Validations Example\" componentName=\"first-example\">\n    <first-example></first-example>\n  </fs-example>\n  <fs-example title=\"Emit Example\" componentName=\"emit-example\">\n    <emit-example></emit-example>\n  </fs-example>\n  <fs-example title=\"Broadcat Example\" componentName=\"broadcast-example\">\n    <broadcast-example></broadcast-example>\n  </fs-example>\n</fs-examples>\n"
...
/***/ "./app/components/broadcast-example/broadcast-example.component.html":
/***/ (function(module, exports) {

module.exports = "<form (fsForm)=\"save()\">\n  <div fxLayout=\"column\">\n   <mat-form-field>\n      <input\n        placeholder=\"Required field\"\n        [(ngModel)]=\"name\"\n        name=\"name\"\n        matInput\n        fsFormRequired=\"true\"\n        />\n    </mat-form-field>\n\n    <fieldset>\n      <legend>Actions</legend>\n      <button mat-raised-button color=\"primary\" type=\"submit\">Submit</button>\n    </fieldset>\n\n    <fieldset>\n      <legend>Broadcast Form Validation Status</legend>\n      <div>{{status}}</div>\n      <p *ngIf=\"form\">{{form|json}}</p>\n    </fieldset>\n  </div>\n</form>\n"

/***/ }),

/***/ "./app/components/broadcast-example/broadcast-example.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var BroadcastExampleComponent = (function () {
    function BroadcastExampleComponent(fsForm) {
        this.fsForm = fsForm;
        this.status = 'Not Submitted';
    }
    BroadcastExampleComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.fsForm.on('submit')
            .subscribe(function (form) {
            _this.status = 'Submitting...';
        });
    ...
    BroadcastExampleComponent.prototype.save = function () { };
    BroadcastExampleComponent = __decorate([
        core_1.Component({
            selector: 'broadcast-example',
            template: __webpack_require__("./app/components/broadcast-example/broadcast-example.component.html")
        }),
        __metadata("design:paramtypes", [src_1.FsForm])
    ], BroadcastExampleComponent);
    return BroadcastExampleComponent;
}());
exports.BroadcastExampleComponent = BroadcastExampleComponent;


/***/ }),

/***/ "./app/components/emit-example/emit-example.component.html":
/***/ (function(module, exports) {

module.exports = "<form (fsForm)=\"save()\" (submit)=\"submitting()\" (invalid)=\"invalid()\" #form=\"ngForm\">\n  <div fxLayout=\"column\">\n   <mat-form-field>\n      <input  placeholder=\"Value >= 3 and <=8\"\n        [(ngModel)]=\"minMaxInput\"\n        name=\"minMaxInput\"\n        matInput\n        [fsFormRequired]=\"required\"\n        fsFormMin=\"3\"\n        fsFormMax=\"8\"\n        fsFormRequiredMessage=\"This is custom required message\"\n        />\n    </mat-form-field>\n\n    <fieldset>\n      <legend>Actions</legend>\n      <button mat-raised-button color=\"primary\" type=\"submit\">Submit</button>\n      <button mat-raised-button color=\"primary\" type=\"button\" (click)=\"emitSubmit()\">Emit Submit</button>\n    </fieldset>\n\n    <fieldset>\n      <legend>Submit Validation Status</legend>\n      <div>{{status}}</div>\n    </fieldset>\n  </div>\n</form>\n"

/***/ }),

/***/ "./app/components/emit-example/emit-example.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__("../node_modules/@angular/core/esm2015/core.js");
var EmitExampleComponent = (function () {
    function EmitExampleComponent() {
        this.status = 'Not Submitted';
    }
    EmitExampleComponent.prototype.ngOnInit = function () { };
    EmitExampleComponent.prototype.submitting = function () {
        this.status = 'Submitting...';
    };
    EmitExampleComponent.prototype.save = function () {
        this.status = 'Valid';
    };
    EmitExampleComponent.prototype.invalid = function (form) {
        this.status = 'Invalid';
    };
    EmitExampleComponent.prototype.emitSubmit = function (form) {
        this.form.ngSubmit.emit();
    };
    __decorate([
        core_1.ViewChild('form'),
        __metadata("design:type", Object)
    ], EmitExampleComponent.prototype, "form", void 0);
    EmitExampleComponent = __decorate([
        core_1.Component({
            selector: 'emit-example',
            template: __webpack_require__("./app/components/emit-example/emit-example.component.html")
        }),
        __metadata("design:paramtypes", [])
    ], EmitExampleComponent);
    return EmitExampleComponent;
}());
exports.EmitExampleComponent = EmitExampleComponent;
...
var FirstExampleComponent = (function () {
    ...
    FirstExampleComponent.prototype.submitting = function () {
        this.status = 'Submitting...';
    };
    ...
    FirstExampleComponent.prototype.invalid = function (form) {
        this.status = 'Invalid';
    };
    FirstExampleComponent.prototype.functionPromise = function (formControl) {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                var testValue = formControl.value;
...
var checkboxgroup_1 = __webpack_require__("../node_modules/@firestitch/checkboxgroup/package/index.js");
var radiogroup_1 = __webpack_require__("../node_modules/@firestitch/radiogroup/package/index.js");
var first_example_component_1 = __webpack_require__("./app/components/first-example/first-example.component.ts");
var emit_example_component_1 = __webpack_require__("./app/components/emit-example/emit-example.component.ts");
var broadcast_example_component_1 = __webpack_require__("./app/components/broadcast-example/broadcast-example.component.ts");
    ...
    PlaygroundModule = __decorate([
        core_1.NgModule({
            ...
            imports: [
                ...
                checkboxgroup_1.FsCheckboxGroupModule,
                radiogroup_1.FsRadioGroupModule,
            ...
            declarations: [
                ...
                emit_example_component_1.EmitExampleComponent,
                broadcast_example_component_1.BroadcastExampleComponent
            ],
            providers: [],
        })
    ], PlaygroundModule);
